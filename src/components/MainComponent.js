...
const [person, setPerson] = useState({
    ...
    return (
        <Routes>
          ...
          <Route path='/login' element={<LoginForm person={setPerson} user ={setUser} isSignup={setIssignup} isLogin={setIslogin}   handleFirstName={handleFirstName} handleEmail={handleEmail} handlePassword={handlePassword} />} />
        </Routes>
    );
